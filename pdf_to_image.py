...
#pages = convert_from_path("CV_Nouman_Ahmad.pdf", 500,poppler_path=r'poppler-0.68.0\bin')
 
def pdf2img():
    try:
        images = convert_from_path(filename,dpi=50,poppler_path=r'poppler-0.68.0\bin')
